"""
Python based calculator with a Win10 like GUI made with thinter.
"""
...
class Calculator:
    def __init__(self):
        ...
        self.total_expression = "" #start with zero
        self.current_expression = "" #start with zero
        ...
        for x in range(1,5): #expands buttons to fill empty spaces
